...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QtOpenSMOKE_PostProcessor_t, stringdata) + ofs \
...
void *QtOpenSMOKE_PostProcessor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QtOpenSMOKE_PostProcessor.stringdata))
