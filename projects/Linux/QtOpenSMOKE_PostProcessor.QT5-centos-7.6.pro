...
INCLUDE_BOOST = /software/chimica2/libraries/boost/boost-1.85.0-gcc-13.2.0/include
INCLUDE_EIGEN = /software/chimica2/libraries/eigen/eigen-3.4.0
INCLUDE_OPENSMOKEPP = ../../../OpenSMOKEpp/source
LIB_BOOST = /software/chimica2/libraries/boost/boost-1.85.0-gcc-13.2.0/lib
...
QMAKE_CXXFLAGS += -DQTVERSION=5 -std=c++17
